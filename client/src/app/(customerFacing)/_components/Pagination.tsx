...
export default function Pagination({currentPage,totalPages,pageSize,totalCount,onPageChange}:PaginationProps){
    ...
    return (
        <nav className="flex items-center justify-between border-t border-neutral-950  px-4 py-3 sm:px-6" aria-label="Pagination">
      <div className="hidden sm:block lg:justify-center">
